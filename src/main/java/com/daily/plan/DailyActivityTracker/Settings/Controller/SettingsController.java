...
public class SettingsController {
    ...
    public void setUserActivities(@RequestBody @Valid UserActivityDTOForStats userActivityDTOForStats) {

        log.info("Entered endpoint [/set/user/activities]");

        settingsService.setUserActivities(userActivityDTOForStats);

    }

    @GetMapping("/get/user/activities")
    @ResponseBody
    public UserActivityDTOForFront getUserActivities() {

        log.info("Entered endpoint [/get/user/activities]");

        return settingsService.getUserActivitiesForFront();
